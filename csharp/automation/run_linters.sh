...
gendarme --ignore "${SCRIPT_DIR}"/gendarme.ignore --html "${SCRIPT_DIR}"/gendarme_report.html "${SCRIPT_DIR}"/../Connector/bin/Debug/netstandard1.1/librtiddsconnector_dotnet.dll
